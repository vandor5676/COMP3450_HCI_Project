    ...
    <div class="flex-grid">
      <div class="row">
        <div class="col profile_img">
          <img alt="Avatar" class="avatar" src={{asset("/images/vendorLogos/meatfarm.png")}}>

        </div>
        <div class="col">
          <div id="vendor_shop_name">Far Farm Meats</div>
          <div id="vendor_date">
...
<section class="products">
      ...
      <div  class="flex-grid current_products">
          <div class="preview_img_container"><img class="product_img" src="../public/images/vendorProducts/steak.jpg" alt=""><span class="preview_img_text">Steak</span></div>
          <div class="preview_img_container"><img class="product_img" src="../public/images/vendorProducts/sausage.jpg" alt=""><span class="preview_img_text">Sausages</span></div>
          <div class="preview_img_container"><img class="product_img" src="../public/images/vendorProducts/ground_meat.jpg" alt=""><span class="preview_img_text">Ground Beef</span></div>
...
function addCode() {
   ...
   "<div style='text-align:center; margin: 1%; max-width:20%;'><img class='product_img' src='../public/images/vendorProducts/jerky.jpg' alt=''><span style='font-size: 20px; color:#464646;'>Lamb Jerky</span></div>");
 }
